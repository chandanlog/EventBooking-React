...
//               eventLocation: item.eventLocation || "Main Venue",
...
//           qrMap[event.eventId] = await QRCode.toDataURL(JSON.stringify(event));
//         }
//         setQrCodeMap(qrMap);
//       } catch (error) {
...
//     doc.text(`Location: ${event.eventLocation}`, margin, 140);
...
//       doc.setFillColor(237, 231, 246); // Light purple background
//       doc.roundedRect(margin, yOffset, pageWidth - 2 * margin, 140, 10, 10, "F");
  
//       // Card border
//       doc.setDrawColor(123, 31, 162); // Dark purple border
//       doc.setLineWidth(1);
...
//         `ID Type: ${(member as any).idType || ""}`,
//         `ID Number: ${(member as any).idNumber || ""}`,
//         `User Type: ${(member as any).userType || ""}`,
//       ];
...
//                           <td style={{ padding: "8px" }}>{member.mobile}</td>
//                         </tr>
//                       ))}
//                     </tbody>
//                   </table>
